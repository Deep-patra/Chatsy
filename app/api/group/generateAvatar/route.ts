...
import { shapes, rings, glass, icons, identicon } from '@dicebear/collection'
import { logger } from '@/utils/logger'

const MODULES = [shapes, rings, glass, identicon]
...
export const GET = async (req: NextRequest) => {
  try {
    ...
    if (!seed) throw new Error('Seed is not present in the request')

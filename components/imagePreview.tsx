  ...
  useEffect(() => {
    const handleOpenPreview = (event: CustomEvent<IPhoto | string>) => {
      ...
      if (typeof detail === "object")
        changeSource(detail.original_url)
    ...
    document.body.addEventListener(events.open_image_preview, handleOpenPreview as any)

    return () => document.body.removeEventListener(events.open_image_preview, handleOpenPreview as any)
